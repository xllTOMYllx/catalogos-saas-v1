function CategoriesCard({ ruta, titulo = "COLECCIÓN DE", subtitulo = "PRODUCTOS", 
  btnText = "Ver nuevas colecciones", onButtonClick }) {
  return (
    <section className="w-full bg-[#121516] rounded-2xl p-4 sm:p-6 md:p-8 flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-0 h-auto sm:h-64">
      ...
      <div className="flex-1 text-center sm:text-left">
        ...
        <button 
          ...
          className="mt-3 sm:mt-4 bg-[#f24427] hover:bg-[#d6331a] text-white px-4 sm:px-6 py-2 rounded-lg font-semibold transition-all hover:scale-105 text-sm sm:text-base disabled:opacity-50 disabled:cursor-not-allowed"
